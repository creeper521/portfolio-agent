...
class ClaimRagDocumentBuilderTest {
    ...
    void derivesOneSubjectIsolatedChunkFromEachPublishedProjectOrCaseClaim() throws Exception {
        PortfolioSnapshot snapshot = new ObjectMapper().findAndRegisterModules().readValue("""
                {"schemaVersion":"4.0","contentVersion":"2026-07-21.1",
                ...
                "projects":[{"id":"project-1","code":"P-01","slug":"sql-audit","title":"SQL Audit","summary":"Summary","background":"Background","responsibilities":["Owner"],"solution":"Solution","keyDecisions":["Decision"],"technologies":["Java"],"verification":["Tested"],"outcome":"Delivered","handoff":"Handoff","status":"DELIVERED","contributionType":"PRIMARY","careerTrack":"JAVA_BACKEND","projectNature":"TOOL","displayTier":"PRIMARY","featuredCaseIds":[],"claimIds":["claim-1"],"evidenceIds":["evidence-1"],"timelineEventIds":["timeline-1"]}],
                "collections":[{"id":"collection-1","slug":"engineering-operations","title":"Engineering operations","summary":"Build cases","displayOrder":10}],
                "cases":[{"id":"case-1","code":"CASE-01","slug":"codegraph-evaluation","type":"EVALUATION","title":"CodeGraph","summary":"Summary","problem":"Problem","actions":["Action"],"decisions":["Decision"],"verification":["Verified"],"outcome":"Prototype","limitations":["Bounded"],"achievementStatus":"PROTOTYPE","contributionType":"PRIMARY","projectId":null,"collectionIds":["collection-1"],"claimIds":["claim-case-1"],"evidenceIds":[],"timelineEventIds":[],"questionPresetIds":[]}],
                "claims":[
        ...
        assertThat(caseDocument.getText())
                .contains("CodeGraph", "Engineering operations", "engineering-operations",
                        "Narrowed scope", "Reviewed source");
        assertThat(caseDocument.getTopics()).contains("engineering-operations");
        assertThat(documents).noneSatisfy(item ->
                assertThat(item.getChunkId()).contains("collection"));

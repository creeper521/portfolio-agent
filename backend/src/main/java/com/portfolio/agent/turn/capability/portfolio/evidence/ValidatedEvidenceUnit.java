 ...
 *
 * <p>由晋级器从候选装配：所属主体（subjectId、subjectKind、subjectTitle、careerTrack、
...
public final class ValidatedEvidenceUnit {
    ...
    public ValidatedEvidenceUnit(
            ...
            AnswerClaimProjection claim, PublicSourceReferenceValue sourceReference) {
        this(subjectId, subjectKind, subjectId, null, Set.of(), claim, sourceReference);
    }
    public ValidatedEvidenceUnit(
            String subjectId, PortfolioSubjectKind subjectKind,
            String subjectTitle, String careerTrack,

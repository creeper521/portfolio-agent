...
public final class ModelOperationPolicy {
    ...
    public OperationReadiness readiness(){if(mode==OperationMode.DISABLED)return OperationReadiness.DISABLED;if(providerRef==null||providerRef.isBlank()||schemaVersion==null||schemaVersion.isBlank())return OperationReadiness.INCOMPLETE_CONFIGURATION;return OperationReadiness.AVAILABLE_WITH_DETERMINISTIC_FALLBACK;}
